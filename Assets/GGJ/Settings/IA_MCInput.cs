...
//     version 1.16.0
//     from Assets/GGJ/Settings/IA_MCInput.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/GGJ/Settings/IA_MCInput.inputactions".
/// </summary>
/// <remarks>
...
public partial class @IA_MCInput: IInputActionCollection2, IDisposable
{
    ...
    ~@IA_MCInput()
    {
        UnityEngine.Debug.Assert(!m_Gameplay.enabled, "This will cause a leak and performance issues, IA_MCInput.Gameplay.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, IA_MCInput.UI.Disable() has not been called.");
    }
    ...
    public struct UIActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public UIActions(@IA_MCInput wrapper) { m_Wrapper = wrapper; }
        /// <summary>
